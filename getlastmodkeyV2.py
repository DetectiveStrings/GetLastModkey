...
class GetLastModKey(common.AbstractWindowsCommand):
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        self._config.add_option('StartToEnd', short_option = 't', default = None, help = 'set start time , end time is set to last edit key', action = 'store')
    ...
    def render_text(self, outfd, data):
        ...
        try : 
            for subkey in regapi.reg_get_all_subkeys(None, key = key):
                xx= 4
            print("subkey found , trying to get last mod keys")
        except : 
            xx = 4
        ...
        if T :
            try : 
                ...
                count = 10000000000
                for t , k in regapi.reg_get_last_modified(hive_name = Hi  , count = 100):
                    if stop_time != 0 :
